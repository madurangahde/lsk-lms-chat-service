...
import { mergeMessages, resolveErrorMessage, upsertConversation } from '../utils/chat.js';
        ...
        <div className="chat-panel">
          <div className="panel-header">
            <div>
              ...
              <div className="muted small">Only you and the admins can see this conversation.</div>
            </div>
          </div>
          {error && <div className="error-banner">{error}</div>}
          <MessageList items={messages} currentUser={user} emptyLabel="Start the conversation with your first message." />
          <MessageComposer onSend={handleSend} sending={sending} placeholder="Write your question or reply to the admin..." />
        </div>
      }
    />
  );
